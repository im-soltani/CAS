<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Pages/Student/MainStudent.master" AutoEventWireup="true" CodeFile="StudentProfile.aspx.cs" Inherits="UI_Pages_Student_StudentProfile" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <%
                ...
                StudentData = Student.GetStudentData(Srl);
                GroupName = Student.GetGroupData(StudentData["Srl_Group"].ToString());
                ...
                <div class="col-md-8 ">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs pull-right">
                            <li class="active"><a href="#ClassRomPlan" data-toggle="tab">برنامه کلاسی</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class=" active tab-pane" id="ClassRomPlan">
                                            ...
                                            <table id="example2" class="table table-bordered table-striped custab">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <% AllDayOfWeak = Student.GetStudentClassRoomPlan(Srl, Term, i, "8:00", "10:00");
                                                            if (AllDayOfWeak != null)
                                                            {%>
                                                        ...
                                                        <% AllDayOfWeak = Student.GetStudentClassRoomPlan(Srl, Term, i, "10:00", "12:00");
                                                            if (AllDayOfWeak != null)
                                                            {%>
                                                        <td><%=AllDayOfWeak["Name"].ToString()+"("+AllDayOfWeak["SessionTypeName"].ToString()+")"%></td>
                                                        <%}
                                                        ...
                                                        <% AllDayOfWeak = Student.GetStudentClassRoomPlan(Srl, Term, i, "12:00", "14:00");
                                                            if (AllDayOfWeak != null)
                                                            {%>
                                                        <td><%=AllDayOfWeak["Name"].ToString()+"("+AllDayOfWeak["SessionTypeName"].ToString()+")"%></td>
                                                        <%}
                                                        ...
                                                        <% AllDayOfWeak = Student.GetStudentClassRoomPlan(Srl, Term, i, "14:00", "16:00");
                                                            if (AllDayOfWeak != null)
                                                            {%>
                                                        <td><%=AllDayOfWeak["Name"].ToString()+"("+AllDayOfWeak["SessionTypeName"].ToString()+")"%></td>
                                                        <%}
                                                        ...
                                                        <% AllDayOfWeak = Student.GetStudentClassRoomPlan(Srl, Term, i, "16:00", "18:00");
                                                            if (AllDayOfWeak != null)
                                                            {%>
                                                        <td><%=AllDayOfWeak["Name"].ToString()+"("+AllDayOfWeak["SessionTypeName"].ToString()+")"%></td>
                                                        <%}
                                                        ...
                                                        <% AllDayOfWeak = Student.GetStudentClassRoomPlan(Srl, Term, i, "18:00", "20:00");
                                                            if (AllDayOfWeak != null)
                                                            {%>
                                                        <td><%=AllDayOfWeak["Name"].ToString()+"("+AllDayOfWeak["SessionTypeName"].ToString()+")"%></td>
                                                        <%}
                            ...
                            <div class=" tab-pane" id="activity">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6 col-md-offset-2">
                                                <img src="../../img/StudentPicture/<%=StudentData["Picture"]%>" style="width: 70px; height: 50px" />
                                            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <h3 class="profile-username text-center"><%=StudentData["Name"].ToString() + " "+StudentData["Family"].ToString()%></h3>

                            <p class="text-muted text-center"><%=GroupName["Name"]%></p>

                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b><i class="fa fa-barcode margin-r-5"></i>شماره دانشجويي</b>
                                    <a style="margin-right: 120px"><%=StudentData["Code"].ToString()%></a>
                                </li>
                                <li class="list-group-item">

                                    <b><i class="fa fa-phone margin-r-5"></i>شماره تلفن</b>
                                    <a style="margin-right: 110px"><%=StudentData["Mobile"].ToString()%></a>
                                </li>
                                <li class="list-group-item">
                                    <b><i class="fa fa-yahoo margin-r-5"></i>آدرس ايميل</b>
                                    <a style="margin-right: 10px"><%=StudentData["Email"].ToString()%></a>
                                </li>
                                <li class="list-group-item">
                                    <b><i class="fa fa-telegram margin-r-5"></i>آدرس تلگرام</b>
                                    <a style="margin-right: 120px"><%=StudentData["TelegramID"].ToString()%></a>
                                </li>
                            </ul>
