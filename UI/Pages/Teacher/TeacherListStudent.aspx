<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Pages/Teacher/MainTeacher.master" AutoEventWireup="true" CodeFile="TeacherListStudent.aspx.cs" Inherits="UI_Pages_Teacher_TeacherListStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <table id="example2" class="table table-bordered table-striped custab" style="margin-top:0%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><%=j%></td>
                                                <td><img src="../../img/<%=AllStudent.Rows[i]["Picture"].ToString()%>.jpg" /></td>
