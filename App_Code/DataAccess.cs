...
public class DataAccess
{
    public DataAccess()
    {
        ...
        {
            connString =
                rootWebConfig.ConnectionStrings.ConnectionStrings["CASConnectionString2"];
            if (connString != null)
    ...
    #region Update
    public bool Update(DataRow dr, int ConditionFieldIndexInDataRow, bool Prompt = false)
    {
        if (dr == null) return false;
    ...
    public bool Update(DataRow dr, string Condition, bool Prompt = false)
    {
        if (dr == null) return false;
